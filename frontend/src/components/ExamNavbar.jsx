...
const ExamNavbar = ({
  ...
  return (
    <div className="z-50 flex items-center justify-between w-full px-6 py-3 bg-card border-b border-border h-24 shadow-sm">
      {/* Left: Test Info */}
      <div className="flex flex-col justify-start items-start gap-2">
        <div className="text-foreground font-medium font-serif">
      ...
      <div className="flex flex-col justify-center items-center gap-2">
        ...
        {showTimer && (
          <p className={`text-2xl font-bold font-mono ${timer < 300 ? "text-destructive" : "text-foreground"}`}>
            {formatTime(timer)}
          </p>
        )}
        <Badge
